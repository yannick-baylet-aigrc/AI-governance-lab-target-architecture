...
+--------------------------+
             ...
             v
+--------------------------+         +--------------------------+         +-------------------------------+
|     Management Plane     |         |   Hardware-backed Auth   |         |      Audit & Monitoring       |
+--------------------------+         |  (e.g., FIDO2 Sec. Key)  |         | (Logs / Events / Traceability)|
             |                       +--------------------------+         +-------------------------------+
             |                                    |                                 |
             |                                    | (Hardware Auth)                 | (Audit / Trace)
             v                                    v                                 v
+---------------------------------------------------------------+                   |
|                         Policy Engine                         | <. . . . . . . . .|                        
|         (Access Control / Risk / Approval Workflow)           |                   |                       
+---------------------------------------------------------------+                   |                       
                             |                                                      |                       
                             v                                                      v (Audit)               
+---------------------------------------------------------------+                   |                       
|                          Agent Layer                          | <. . . . . . . . .|                       
|             (Identity / Tools / Least Privilege)              |                   |                       
+---------------------------------------------------------------+                   |                       
                             |                                                      |                       
                             v                                                      v (Audit)               
+---------------------------------------------------------------+                   |                       
